...
urlpatterns = [
    ...
    path('my-school-scores/', views.get_my_school_scores, name='get_my_school_scores'),
    ...
    path('coins/balance/', views.get_coin_balance, name='get_coin_balance'),
    path('coins/transactions/', views.get_coin_transactions, name='get_coin_transactions'),
    path('coins/check-daily-login/', views.check_daily_login_reward, name='check_daily_login_reward'),
    
    # Student Feedback endpoints
    path('feedback/submit/', views.submit_student_feedback, name='submit_student_feedback'),
    path('feedback/status/', views.get_student_feedback_status, name='get_student_feedback_status'),
