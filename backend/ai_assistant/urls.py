...
urlpatterns = [
    ...
    # Calendar endpoints
    path('calendar/save/', views.save_calendar_entry, name='save_calendar_entry'),
    path('calendar/save-multiple/', views.save_calendar_entries, name='save_calendar_entries'),
    path('calendar/entries/', views.get_calendar_entries, name='get_calendar_entries'),
]
