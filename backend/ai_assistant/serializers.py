...
class CalendarSerializer(serializers.ModelSerializer):
    ...
    duration = serializers.CharField(max_length=50, default='60 minutes')
    ...
    class Meta:
        model = Calendar
        fields = [
            'calendar_id', 'student_id', 'entry_date', 'subject', 'topic',
            'duration', 'class_name', 'chapter', 'subtopic', 'plan_id',
            'completed', 'created_at', 'updated_at'
        ]
        read_only_fields = ['calendar_id', 'created_at', 'updated_at']
