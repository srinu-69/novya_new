...
class Calendar(models.Model):
    ...
    duration = models.CharField(max_length=50, default='60 minutes')
    class_name = models.CharField(max_length=50, null=True, blank=True)
    chapter = models.CharField(max_length=200, null=True, blank=True)
    subtopic = models.CharField(max_length=200, null=True, blank=True)
    plan_id = models.IntegerField(null=True, blank=True)  # Optional reference to ai_study_plans(plan_id)
    ...
    def __str__(self):
        return f"Calendar Entry - {self.subject} - {self.entry_date} - Student {self.student_id}"
