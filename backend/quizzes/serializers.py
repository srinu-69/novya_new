...
class MockTestAttemptSubmissionSerializer(serializers.Serializer):
    ...
    testType = serializers.CharField(required=False, default='mock_test', allow_blank=True)
    ...
    className = serializers.CharField(max_length=50, required=False, allow_blank=True)
    difficultyLevel = serializers.ChoiceField(choices=['simple', 'medium', 'hard'], default='simple', required=False)
    language = serializers.CharField(max_length=10, default='English', required=False, allow_blank=True)
