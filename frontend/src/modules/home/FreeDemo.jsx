...
function FreeDemo() {
 ...
 const [formData, setFormData] = useState({
  ...
  <select
    ...
    required
  >
    <option value="">{t('Select_your_grade')}</option>

    <option value="Grade 7">{t('Grade_7')}</option>
    <option value="Grade 8">{t('Grade_8')}</option>
    <option value="Grade 9">{t('Grade_9')}</option>
